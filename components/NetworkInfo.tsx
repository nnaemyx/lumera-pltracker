...
export default function NetworkInfo() {
  return (
    <div className="bg-gradient-to-br from-[#111118] to-[#0f0f15] rounded-3xl p-7 border-2 border-indigo-500/20 shadow-xl backdrop-blur-md">
      <h3 className="text-2xl font-black text-white mb-6 tracking-tight" style={{ fontFamily: 'var(--font-outfit)' }}>
        Network Status
      </h3>
      <div className="space-y-5">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-semibold text-white uppercase tracking-wider" style={{ fontFamily: 'var(--font-outfit)' }}>
                Network
              </p>
          ...
          <span className="px-4 py-2 bg-indigo-500/20 text-indigo-400 rounded-full text-xs font-bold border-2 border-indigo-400/40 shadow-lg uppercase tracking-wider" style={{ fontFamily: 'var(--font-outfit)' }}>
            Active
          </span>
        </div>
